...
if __name__ == "__main__":
    ...
    # === ROUND 2: Imperial March (Repeat) ===
    # MOVE 19-36: Second iteration with different colors
    m.drive(18, 0)
    ...
    # === ROUND 3: Imperial March (Repeat with variations) ===
    # More spins, less forward movement
    m.drive(15, 0)
    ...
    m.drive(12, math.radians(90))
    change_color((128,255,128))
    change_sound(melody[13][0], 22000)
    time.sleep_ms(melody[13][1])
    m.stop()
    time.sleep_ms(50)
    ...
    # GRAND FINALE: Triple spin with rainbow
    m.drive(0, math.radians(1080))
    change_sound(melody[17][0], 20000)
    for i in range(10):
        colors = [(255,0,0), (255,128,0), (255,255,0), (0,255,0), (0,255,255), (0,0,255), (128,0,255), (255,0,255)]
        change_color(colors[i % len(colors)])
        time.sleep_ms(100)
    m.stop()
    
    # Final shimmy celebration!
    change_sound(523, 18000)
    m.drive(15, 0)
